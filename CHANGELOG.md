...
### Added
- **Phenocams Database Integration Tasks** (`docs/PHENOCAMS_DATABASE_INTEGRATION_TASKS.md`):
  - Comprehensive implementation plan for direct database integration between PhenoTag and Phenocams
  - 6 phases covering database connection, annotation mapping, UI integration, safety features, testing, and deployment
  - 16 implementation tasks with code examples and test scenarios
  - Architecture decision documentation and risk mitigation strategies

## [0.1.6] - 2025-11-25

### Fixed
- **Auto-select first day when calendar loads**: Fixed issue where "No image files found for day None"
  was displayed even when images were available. Now auto-selects the first available day when:
  - Calendar scan completes and finds available days
  - Calendar renders but no day is selected yet
